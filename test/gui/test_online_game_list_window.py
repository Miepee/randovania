...
async def test_attempt_join(mock_execute_dialog: AsyncMock,
    ...
    session_a = MultiplayerSessionListEntry(id=1, name="A Game", has_password=True, state=MultiplayerSessionState.FINISHED,
                                            num_players=1, creator="You",
                                            creation_date=datetime.datetime(year=2015, month=5, day=1, tzinfo=utc))
    session_b = MultiplayerSessionListEntry(id=2, name="B Game", has_password=True, state=MultiplayerSessionState.IN_PROGRESS,
                                            num_players=1, creator="You",
